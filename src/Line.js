...
export default class LineChart extends Component {
  ...
  render() {
    ...
    let showAreas =
      typeof this.props.options.showAreas !== "undefined"
        ? this.props.options.showAreas
        : true;
    let strokeWidth =
      typeof this.props.options.strokeWidth !== "undefined"
        ? this.props.options.strokeWidth
        : "1";
    let strokeDasharray =
      typeof this.props.options.strokeDasharray !== "undefined"
        ? this.props.options.strokeDasharray
        : [];
    let strokeOpacity =
      typeof this.props.options.strokeOpacity !== "undefined"
    ...
    let lines = _.map(
      ...
      function(c, i) {
        const strokeWidthForCurve =
          (typeof strokeWidth === "function" && strokeWidth(c, i)) ||
          strokeWidth;
        const strokeDasharrayForCurve =
          (typeof strokeDasharray === "function" && strokeDasharray(c, i)) ||
          strokeDasharray;
        const strokeOpacityForCurve =
          (typeof strokeOpacity === "function" && strokeOpacity(c, i)) ||
          strokeOpacity;
        return (
          <Svg.Path
            key={"lines" + i}
    ...
    let showPoints =
      typeof this.props.options.showPoints !== "undefined"
    ...
    if (this.props.regions != "undefined") {
      let styling =
        typeof this.props.regionStyling != "undefined"
          ? this.props.regionStyling
          : {};
      let labelOffsetAllRegions =
        typeof styling.labelOffset != "undefined" ? styling.labelOffset : {};
      ...
      regions = _.map(
        ...
        function(c, i) {
          ...
          let labelOffset =
            typeof c.labelOffset != "undefined" ? c.labelOffset : {};
          let labelOffsetLeft =
            typeof labelOffsetAllRegions.left != "undefined"
              ? typeof labelOffset.left != "undefined"
                ? labelOffset.left
                : labelOffsetAllRegions.left
              : 20;
          let labelOffsetTop =
            typeof labelOffsetAllRegions.top != "undefined"
              ? typeof labelOffset.top != "undefined"
                ? labelOffset.top
                : labelOffsetAllRegions.top
              : 0;
          let fillOpacity =
            typeof styling.fillOpacity != "undefined"
